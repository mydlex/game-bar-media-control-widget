...
namespace GameBarMediaWidget
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            if (widgetArgs != null)
            {
                ...
                if (widgetArgs.IsLaunchActivation)
                {
                    ...
                    if(widgetArgs.AppExtensionId == "MediaControlWidget")
                    {
                        ...
                        Window.Current.Closed += OnMainPageClosed;
                    }
                    else if (widgetArgs.AppExtensionId == "MediaControlSettingsWidget")
                    {
                        ...
                        widgetSettings = new XboxGameBarWidget(
                            ...
                            Window.Current.CoreWindow,
                            rootFrame);
                        rootFrame.Navigate(typeof(WidgetSettings), widgetSettings);
        ...
        private void WidgetSettingsWindow_Closed(object sender, CoreWindowEventArgs e)
        {
            widgetSettings = null;
            Window.Current.Closed -= WidgetSettingsWindow_Closed;
        }

        private void OnMainPageClosed(object sender, Windows.UI.Core.CoreWindowEventArgs e)
        {
            widget = null;
            Window.Current.Closed -= OnMainPageClosed;
        }
